-- ======================================================================
-- TERRANEX BIOMÉTHANE - ÉTAPE 12: SEMANTIC VIEW COMPLÈTE
-- ======================================================================
-- Description: Création de la vue sémantique Terranex pour Cortex Analyst
-- Format: Semantic View avec facts, dimensions, metrics et synonymes
...
CREATE OR REPLACE SEMANTIC VIEW DB_TERRANEX.PRODUCTION.TERRANEX_BIOMETHAN_SEMANTIC_VIEW
    ...
    with extension (CA='{"tables":[{"name":"INJECTION_FACT","dimensions":[{"name":"ID_ANALYSE_QUALITE"},{"name":"ID_INJECTION"},{"name":"ID_POSTE_RESEAU"},{"name":"ID_SITE"},{"name":"ID_TEMPS"},{"name":"STATUT_INJECTION"}],"facts":[{"name":"DEBIT_MOYEN_M3_H"},{"name":"DUREE_INJECTION_MINUTES"},{"name":"ENERGIE_INJECTEE_MWH"},{"name":"PRESSION_INJECTION_BAR"},{"name":"TEMPERATURE_GAZ_CELSIUS"},{"name":"VOLUME_INJECTE_M3"}],"metrics":[{"name":"ENERGIE_TOTALE"},{"name":"VOLUME_TOTAL"},{"name":"NB_INJECTIONS"}],"time_dimensions":[{"name":"CREATED_AT"}]},{"name":"QUALITE_DIM","dimensions":[{"name":"ID_ANALYSE_QUALITE"},{"name":"LABORATOIRE_ANALYSE"},{"name":"METHODE_ANALYSE"},{"name":"STATUT_CONFORMITE"}],"facts":[{"name":"PCS_KWH_M3"},{"name":"TENEUR_CO2_POURCENTAGE"},{"name":"TENEUR_H2S_PPM"},{"name":"WOBBE_INDEX"}],"time_dimensions":[{"name":"CREATED_AT"}]},{"name":"RESEAU_DIM","dimensions":[{"name":"ID_POSTE_RESEAU"},{"name":"NOM_POSTE_INJECTION"},{"name":"STATUT_OPERATIONNEL"},{"name":"TYPE_POSTE"},{"name":"ZONE_GEOGRAPHIQUE_RESEAU"}],"facts":[{"name":"CAPACITE_INJECTION_MAX_NM3_H"},{"name":"NIVEAU_PRESSION_BAR"}],"time_dimensions":[{"name":"CREATED_AT"}]},{"name":"SITE_DIM","dimensions":[{"name":"DEPARTEMENT"},{"name":"ID_SITE"},{"name":"NOM_PRODUCTEUR"},{"name":"NOM_SITE"},{"name":"REGION"},{"name":"STATUT_OPERATIONNEL"},{"name":"TECHNOLOGIE_PRODUCTION"},{"name":"TYPE_INTRANTS"}],"facts":[{"name":"CAPACITE_NOMINALE_MWH_JOUR"}],"time_dimensions":[{"name":"CREATED_AT"},{"name":"DATE_MISE_SERVICE"}]},{"name":"TEMPS_DIM","dimensions":[{"name":"EST_FERIE"},{"name":"ID_TEMPS"},{"name":"JOUR_DE_LA_SEMAINE"},{"name":"MOIS_NOM"},{"name":"NOM_FERIE"},{"name":"TRIMESTRE"}],"facts":[{"name":"ANNEE"},{"name":"SEMAINE_NUMERO"}],"time_dimensions":[{"name":"CREATED_AT"},{"name":"DATE_COMPLETE"}]}],"relationships":[{"name":"INJECTIONS_TO_SITES"},{"name":"INJECTION_TO_TEMPS"},{"name":"INJECTION_TO_RESEAU"},{"name":"INJECTION_TO_ANALYSE"}]}');

SELECT '🧠 Vue sémantique TERRANEX_BIOMETHAN_SEMANTIC_VIEW créée avec succès !' AS status;
...
SELECT 
    '',
    'Facts',
    '13 faits avec synonymes et commentaires'
UNION ALL
SELECT 
    '',
    'Dimensions',
    '25+ dimensions avec synonymes'
UNION ALL
SELECT 
    '',
    'Metrics',
...
SELECT 
    '',
    'Usage',
    'Prête pour questions en langage naturel';

SELECT '✅ VUE SÉMANTIQUE TERRANEX PRÊTE POUR CORTEX ANALYST !' AS statut_final;
